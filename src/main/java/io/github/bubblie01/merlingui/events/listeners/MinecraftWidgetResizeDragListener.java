...
public class MinecraftWidgetResizeDragListener implements MouseDragEventListener
{

    public static final float THRESHOLD = 0.0001f;
    private Button resizeButton;
    private MinecraftWidget widget;

  public MinecraftWidgetResizeDragListener(Button resizeButton, MinecraftWidget widget)
  {
