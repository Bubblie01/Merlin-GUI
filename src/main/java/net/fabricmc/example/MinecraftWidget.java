...
public class MinecraftWidget extends Component {
    ...
    private void initialize(String title) {
        ...
        icon.setPosition(new Vector2f(0, 0));
        ...
        resizeButton.getStyle().getBackground().setColor(ColorConstants.black());
